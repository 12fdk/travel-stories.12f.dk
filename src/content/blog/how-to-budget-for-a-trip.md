---
title: "How to Budget for a Trip: A Simple Travel Budget That Works"
...
faq:
  ...
  - question: "What is a good travel budget breakdown?"
    answer: "A common rule of thumb is about 30% for transport to the destination, 25% for accommodation, 20% for food, 10% for activities, 5% for local transit, and 10% held as a buffer. Treat it as a starting point, not a law. A road trip shifts money from flights to fuel, and a food-focused city break might double the food share."
  - question: "Why do I need a buffer in my travel budget?"
    answer: "Because something unplanned happens on almost every trip: a missed connection, a checked-bag fee, a rainy-day activity, or a dinner that ran long. A 10-15% buffer absorbs these without forcing you to cut the rest of the trip. If you come home without touching it, it simply becomes savings."
  - question: "Should I track expenses during my trip or just plan beforehand?"
...
5. **Local transit.** Metro passes, taxis, ride shares, bike rentals, parking. Rarely huge, but it is a real line and it adds up in cities.
6. **Buffer.** A reserve of 10-15% of the total that is not assigned to anything. More on why below.

Some trips need extra lines — visas, travel insurance, vaccinations, pet sitting at home — but almost every expense you will meet fits one of the six. If you are still deciding where to go and when, sort that out first with a proper planning pass; our guide on [how to plan a trip step by step](/blog/how-to-plan-a-trip-step-by-step/) covers the sequence.
...
And before you leave, make sure the budget is not the only thing that is ready — run through a proper [pre-departure checklist](/blog/travel-checklist-before-leaving/) so a forgotten document does not become the buffer's first casualty.
